    ...
    <>
      <div>
        <div className='container pt-1 pb-3'>
          <div className='navbar'>
            ...
            <div className='navbar navbar-all'>
              ...
              <Link to="#" style={{ textDecoration: 'none' }}><p>LIVE CLASSES</p></Link>
              <Link to="#" style={{ textDecoration: 'none' }}><p>PRACTICES</p></Link>
              <Link to="#" style={{ textDecoration: 'none' }}><p>RESOURCES</p></Link>
              <Link to="#" style={{ textDecoration: 'none' }}><p>OUR PRODUCTS</p></Link>
            </div>
            <hr />
          </div>
        ...
        <div className='container'>
          <img className='w-100' src="https://www.guvi.in/blog/wp-content/uploads/2022/10/blog-header-2048x315.png" referrerpolicy="no-referrer" alt="guvi" height="200" />
        </div>
        <div className='container'>
          <div className='navbar navbar-course mt-5 mb-5 w-75 mx-auto '>
